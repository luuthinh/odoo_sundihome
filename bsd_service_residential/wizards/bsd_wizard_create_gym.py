...
class BsdWizardCreateGym(models.TransientModel):
    _name = 'bsd.wizard.create.gym'
    ...
    bsd_residential_gym_id = fields.Many2one('bsd.residential.gym', string='Hội viên Gym')
    ...
    @api.onchange('bsd_residential_gym_id')
    ...
    def action_create(self):
        if self.bsd_type == 'new':
            self.env['bsd.residential.gym'].create({
                'bsd_sequence': 'New',
